...
interface NewPricingFormProps {
  onClose: () => void;
}

export function NewPricingForm({ onClose }: NewPricingFormProps) {
  const addPricing = useSettingsStore((state) => state.addPricing);
  ...
  const onSubmit = async (data: any) => {
    try {
      addPricing(data);
      toast.success('Pricing configuration added successfully!');
      onClose();
    } catch (error) {
